...
int main()
{
	 ...
	 * */
	/* TODO: finish our fibonacci code from class.
	 * TODO: make code from class actually useful (say, use it to
	 * compute and output the kth term of the sequence).  Then
	 * generalize to lucas sequences (see above).
	 * */
